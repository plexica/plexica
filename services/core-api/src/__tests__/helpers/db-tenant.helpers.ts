...
// ADR-028: generated by `pnpm db:generate` (prepare script) — always present after install.
...
import { MIGRATIONS_DIR, TENANT_MIGRATION_FILES } from '../../lib/multi-schema-migrate.js';
