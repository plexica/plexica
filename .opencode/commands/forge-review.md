...
Runs two **independent** adversarial reviews in parallel — Claude Opus 4.6 (`forge-reviewer`) and GPT-5.3-Codex (`forge-reviewer-codex`) — then synthesizes findings.
...
1. **Label** every finding: `[OPUS]` or `[CODEX]`.
