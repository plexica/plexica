...
grep -Fxe 'RATE_LIMIT_MAX=10000' -e 'ADMIN_RATE_LIMIT_MAX=10000' -e 'RATE_LIMIT_RESOLVE_MAX=30' -e 'NOTIFICATION_SSE_CONNECT_RATE_LIMIT=100' "$CI_RUNTIME_DIR/container.env" >/dev/null
