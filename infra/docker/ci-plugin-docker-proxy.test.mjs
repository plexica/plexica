...
try {
  const create = JSON.stringify({
    ...
    HostConfig: {
      Binds: ['/run/plexica-ci-plexica-ci-proxy-123456789012345678901234567/postgres-ca.crt:/tmp/plexica-postgres-ca.crt:ro'],
  ...
  if (
    ...
    created.HostConfig.Binds?.[0] !== '/run/plexica-ci-plexica-ci-proxy-123456789012345678901234567/postgres-ca.crt:/tmp/plexica-postgres-ca.crt:ro' ||
