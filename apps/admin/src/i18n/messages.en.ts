...
export const messages = {
  ...
  'admin.provision.review.newBucket': 'new storage bucket',
  'admin.provision.review.tempPassword': 'temp password will be generated',
  'admin.provision.review.warning': 'This will create a PostgreSQL schema, a Keycloak realm, and a storage bucket. This takes about 20–30 seconds.',
  ...
  'admin.provision.error.conflict.bucket_exists': 'A storage bucket with this name already exists. Choose a different slug.',
