...
const menuItems: MenuItem[] = [
  ...
  { label: 'Tenants', path: '/tenants', icon: <Building2 className="w-5 h-5" /> },
  { label: 'Plugins', path: '/plugins', icon: <Puzzle className="w-5 h-5" /> },
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto py-4">
        ...
        <div className="px-3 py-2">
          ...
          {menuItems.map((item) => (
            <Link key={item.path} to={item.path as never}>
              <div
