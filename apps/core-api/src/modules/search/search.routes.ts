    ...
    '/search',
    {
      schema: {
        ...
        response: {
          ...
          500: { description: 'Search failed', type: 'object', additionalProperties: true },
        },
      },
    },
    ...
    '/search/index',
    {
      schema: {
        ...
        response: {
          ...
          500: { description: 'Indexing failed', type: 'object', additionalProperties: true },
        },
      },
    ...
    '/search/:documentId',
    {
      schema: {
        ...
        response: {
          ...
          500: { description: 'Delete failed', type: 'object', additionalProperties: true },
        },
      },
      preHandler: adminOnly,
    },
    ...
    '/search/reindex',
    {
      schema: {
        ...
        response: {
          ...
          400: {
            description: 'Missing type in request body',
            type: 'object',
            additionalProperties: true,
          },
          403: {
          ...
          500: { description: 'Reindex failed', type: 'object', additionalProperties: true },
        },
      },
      preHandler: adminOnly,
    },
