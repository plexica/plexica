...
- [x] **1.1** `[S]` `[002-07]` `[P]` Add `minio_bucket` column migration
...
- [x] **1.2** `[S]` `[002-07]` `[P]` Update Prisma schema for `minio_bucket`
...
- [x] **1.3** `[S]` `[002-02]` `[EC-01]` `[EC-02]` `[P]` Implement typed application error classes
...
- [x] **1.4** `[S]` `[002-03]` `[P]` Extend config with JWKS TTL + realm-prefix settings
...
- [x] **1.5** `[S]` `[002-10]` `[P]` Add `jose` and frontend dependencies to package manifests
...
- [x] **1.6** `[S]` `[002-09]` `[P]` Define shared TypeScript types — auth & tenant
...
- [x] **2.1** `[M]` `[002-03]` `[NFR-02]` `[NFR-03]` `[EC-06]` Implement JWKS cache
...
- [x] **2.2** `[M]` `[002-02]` `[EC-06]` Implement auth middleware
...
- [x] **2.3** `[S]` `[EC-01]` `[EC-02]` Implement centralized error handler plugin
...
- [x] **2.4** `[S]` `[002-02]` `[002-15]` Implement `GET /api/me` route
...
- [x] **2.5** `[S]` `[002-02]` Register auth middleware, error handler and user routes in app entry
...
- [x] **2.6** `[S]` `[002-09]` Run Prisma migration for `minio_bucket` column
...
- [x] **3.1** `[S]` `[002-08]` `[EC-07]` Implement AsyncLocalStorage tenant context store
...
- [x] **3.2** `[M]` `[002-07]` `[002-08]` `[EC-01]` `[EC-02]` `[EC-07]` Implement tenant context middleware
...
- [x] **3.3** `[S]` `[002-07]` `[002-08]` Register tenant context middleware in app entry
  - **File**: `services/core-api/src/index.ts`
  - **Type**: Modify existing
...
- [x] **4.1** `[S]` `[002-10]` `[P]` Update `tenant-schema.ts` for provisioning integration
...
- [x] **4.2** `[M]` `[002-10]` `[EC-03]` `[P]` Implement Keycloak Admin REST client
...
- [x] **4.3** `[S]` `[002-10]` `[EC-04]` `[P]` Implement MinIO bucket client
...
- [x] **4.4** `[M]` `[002-10]` `[EC-03]` `[EC-04]` `[NFR-05]` Implement tenant provisioning orchestrator
...
- [x] **4.5** `[M]` `[002-06]` `[002-10]` `[002-12]` Implement tenant API routes
...
- [x] **4.6** `[M]` `[002-12]` `[EC-08]` `[NFR-06]` Implement multi-schema migration runner
...
- [x] **4.7** `[S]` `[002-10]` `[002-12]` Register tenant routes in app entry
  - **File**: `services/core-api/src/index.ts`
  - **Type**: Modify existing
...
- [x] **5.1** `[S]` `[002-06]` `[P]` Implement tenant resolver service
...
- [x] **5.2** `[M]` `[002-01]` `[002-04]` `[002-05]` `[P]` Implement Keycloak OIDC auth service
...
- [x] **5.3** `[S]` `[002-02]` `[002-05]` `[EC-05]` `[P]` Implement API client
...
- [x] **5.4** `[M]` `[002-01]` `[002-04]` `[002-05]` `[002-18]` `[EC-05]` Implement Zustand auth store
...
- [x] **5.5** `[S]` `[002-01]` `[002-06]` Configure TanStack Router
...
- [x] **5.6** `[S]` `[002-01]` `[002-02]` Implement auth callback page
...
- [x] **5.7** `[S]` `[002-06]` `[EC-01]` `[EC-02]` Implement organization error page
...
- [x] **5.8** `[S]` `[002-01]` `[002-18]` Implement auth guard
...
- [x] **5.9** `[S]` `[002-04]` `[002-05]` `[EC-05]` Implement session expired handler
...
- [x] **5.10** `[S]` `[002-15]` `[002-19]` Implement `useCurrentUser` TanStack Query hook
...
- [x] **5.11** `[M]` `[002-01]` `[002-18]` Wire up app entry point and providers
...
- [x] **5.12** `[S]` `[002-17]` Add auth + tenant i18n messages
...
- [x] **5.13** `[S]` `[002-19]` Add Vite dev API proxy
...
- [x] **6.1** `[S]` `[002-13]` `[002-20]` `[P]` Implement skip-to-content link
...
- [x] **6.2** `[S]` `[002-13]` `[002-20]` `[P]` Implement user avatar component
...
- [x] **6.3** `[S]` `[002-04]` `[002-13]` `[P]` Implement user menu dropdown
...
- [x] **6.4** `[S]` `[002-13]` `[P]` Implement breadcrumb component
...
- [x] **6.5** `[S]` `[002-13]` `[002-20]` `[P]` Implement sidebar nav item
...
- [x] **6.6** `[M]` `[002-13]` `[002-20]` `[P]` Implement sidebar component
...
- [x] **6.7** `[M]` `[002-13]` `[002-20]` `[P]` Implement header component
...
- [x] **6.8** `[M]` `[002-13]` `[002-14]` `[002-20]` Implement AppShell layout component
...
- [x] **6.9** `[S]` `[002-13]` `[P]` Implement skeleton loader component
...
- [x] **6.10** `[S]` `[002-13]` `[P]` Implement empty state component
...
- [x] **6.11** `[S]` `[002-16]` `[P]` Implement error fallback UI
...
- [x] **6.12** `[M]` `[002-16]` `[P]` Implement route-level error boundary
...
- [x] **6.13** `[M]` `[002-15]` `[002-17]` `[002-19]` Implement dashboard page
...
- [x] **6.14** `[S]` `[002-13]` `[002-16]` Wire shell, dashboard and error boundary into router
  - **File**: `apps/web/src/router.tsx`
  - **Type**: Modify existing
...
- [x] **6.15** `[S]` `[002-17]` Add shell + dashboard i18n messages
  - **File**: `apps/web/src/i18n/messages.en.ts`
  - **Type**: Modify existing
  - **Location**: Messages export object
...
- [x] **6.16** `[S]` `[002-14]` Export new UI primitives from design system package
...
- [x] **7.1** `[M]` `[002-02]` `[002-03]` `[NFR-02]` `[NFR-03]` `[EC-06]` Auth middleware integration tests
...
- [x] **7.2** `[M]` `[002-07]` `[002-08]` `[002-11]` `[NFR-04]` `[EC-07]` Tenant context isolation tests
...
- [x] **7.3** `[M]` `[002-11]` `[NFR-04]` `[P]` Cross-tenant isolation proof test
...
- [x] **7.4** `[L]` `[002-10]` `[EC-03]` `[EC-04]` `[NFR-05]` `[P]` Tenant provisioning tests
...
- [x] **7.5** `[M]` `[002-12]` `[EC-08]` `[NFR-06]` `[P]` Multi-schema migration tests
...
- [x] **7.6** `[S]` `[002-02]` `[002-06]` `[002-15]` `[P]` User routes and tenant resolve integration tests
...
- [x] **8.1** `[L]` `[002-01]` `[002-02]` `[002-06]` `[002-15]` `[NFR-01]` Configure Playwright for multi-subdomain + write login flow E2E
...
- [x] **8.2** `[M]` `[002-04]` `[P]` Logout E2E test
...
- [x] **8.3** `[S]` `[002-06]` `[EC-01]` `[EC-02]` `[P]` Organization error page E2E
...
- [x] **8.4** `[M]` `[002-11]` `[NFR-04]` `[P]` Cross-tenant isolation E2E
...
- [x] **8.5** `[M]` `[002-20]` `[NFR-08]` `[P]` Shell accessibility E2E audit
...
- [x] **8.6** `[S]` `[002-16]` `[P]` Error boundary recovery E2E
...
- [x] **9.1** `[S]` `[NFR-07]` Verify shell first contentful paint performance
  - **File**: `apps/web/e2e/login-flow.spec.ts`
  - **Type**: Modify existing
...
- [x] **9.2** `[S]` `[ALL]` Verify responsive breakpoints manually
...
- [x] **9.3** `[S]` `[ALL]` Run `pnpm --filter core-api test` and confirm all pass
...
- [x] **9.4** `[S]` `[ALL]` Run `pnpm --filter web test:e2e` and confirm all pass
...
- [x] **9.5** `[S]` `[ALL]` Run `/forge-review` adversarial review
