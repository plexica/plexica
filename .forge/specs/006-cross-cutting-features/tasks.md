...
- [ ] **1.1** `[M]` `[FR-006-03]` Core `EmailQueue` Prisma model + migration
...
- [ ] **1.2** `[M]` `[FR-006-01]` Tenant `Notification` Prisma model + relation
...
- [ ] **1.3** `[M]` `[FR-006-01]` `[FR-006-10]` Tenant raw-SQL migrations + registration
...
- [ ] **1.5** `[S]` `[FR-006-06]` `[P]` Add `eslint-plugin-formatjs` devDependency
...
- [ ] **1.6** `[M]` `[FR-006-01]` `[FR-006-03]` `[FR-006-15]` `[FR-006-17]` `[P]` Config env vars + `.env.example`
...
- [ ] **1.7** `[S]` `[FR-006-01]` `[P]` Rate-limit preset `SSE_CONNECT_RATE_LIMIT`
...
- [ ] **1.8** `[M]` `[FR-006-01]` `[FR-006-02]` `[FR-006-04]` `[FR-006-13]` `[P]` Shared API types package
...
- [ ] **1.9** `[S]` `[FR-006-05]` SDK notification emission
...
- [ ] **2.1** `[M]` `[FR-006-01]` `[P]` Notification connection manager
...
- [ ] **2.2** `[S]` `[FR-006-01]` `[P]` SSE framing helpers
...
- [ ] **2.3** `[M]` `[FR-006-01]` `[FR-006-02]` `[FR-006-04]` `[FR-006-05]` `[P]` Notification types + Zod schemas
...
- [ ] **2.5** `[M]` `[FR-006-01]` `[FR-006-02]` `[FR-006-04]` Notification service
...
- [ ] **2.9** `[S]` `[FR-006-05]` `[P]` Emit rate limiter
...
- [ ] **2.10** `[S]` `[FR-006-03]` `lib/email.ts` — enqueue path + invitation reroute
...
- [ ] **2.11** `[M]` `[FR-006-01]` `[P]` Invitation outbox emission
...
- [ ] **2.12** `[M]` `[FR-006-03]` `[P]` GDPR email-queue purge step (F8)
...
- [ ] **3.1** `[M]` `[FR-006-01]` `[NFR-006-1]` SSE stream route
...
- [ ] **3.2** `[M]` `[FR-006-02]` `[FR-006-04]` `[NFR-006-6]` Center, preferences & types routes
...
- [ ] **3.3** `[M]` `[FR-006-05]` Plugin emission route
...
- [ ] **3.4** `[S]` Module registration + `index.ts` wiring
...
- [ ] **3.5** `[M]` `[FR-006-01]` `[NFR-006-2]` Frontend SSE client + notifications API
...
- [ ] **3.6** `[M]` `[FR-006-02]` Notification center UI
...
- [ ] **3.7** `[M]` `[FR-006-04]` Notification preferences UI
...
- [ ] **3.8** `[M]` `[FR-006-01]` `[FR-006-02]` `[FR-006-05]` Notification i18n strings (EN/IT)
...
- [ ] **3.9** `[S]` `[FR-006-01]` `[FR-006-03]` Bootstrap lifecycle wiring
...
- [ ] **3.10** `[M]` `[FR-006-01]` `[P]` Unit tests — connection manager
...
- [ ] **3.11** `[M]` `[FR-006-02]` `[FR-006-04]` `[P]` Unit tests — notification service
...
- [ ] **3.12** `[S]` `[FR-006-05]` `[P]` Unit tests — emit rate limiter
...
- [ ] **3.15** `[L]` `[FR-006-01]` `[NFR-006-2]` E2E — `notification-sse.spec.ts`
...
- [ ] **3.16** `[M]` `[FR-006-02]` `[P]` E2E — `notification-center.spec.ts`
...
- [ ] **3.17** `[M]` `[FR-006-03]` `[P]` E2E — `notification-email.spec.ts`
...
- [ ] **3.18** `[M]` `[FR-006-04]` `[NFR-006-6]` `[P]` E2E — `notification-prefs.spec.ts`
...
- [ ] **3.19** `[M]` `[FR-006-05]` `[P]` E2E — `plugin-notification.spec.ts`
...
| Phase | Tasks | Parallel | Effort (midpoint) |
| ----- | ----- | -------- | ----------------- |
| 1 — Foundation | 9  | 5 | ~8 h |
| 2 — Notifications core | 12 | 7 | ~14 h |
| 3 — Notifications interface/UI/tests | 19 | 7 | ~26 h |
| 4 — Internationalization | 9  | 3 | ~15 h |
| 5 — User Profile | 8  | 3 | ~12 h |
| 6 — Observability | 13 | 3 | ~18 h |
| 7 — Integration & Polish | 3  | 0 | ~3 h |
