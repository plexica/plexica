...
| 006-03 | Email notifications | Workspace invite arrives via email (Mailhog in test) |
...
| Email delivery reliability in prod | MEDIUM | Retry queue for failed sends; Mailhog for dev/test; dead-letter logging |
