...
| Field           | Value                                                                            |
| --------------- | -------------------------------------------------------------------------------- |
| Feature         | Frontend Architecture — App Shell, Plugin Loading, Theming, Widgets, Auth States |
...
| │ Dash- │ |  │                                                  │  |
| │ board │ |  │ [Page Title: Dashboard]                          │  |
| ├──────┤ |  │                                                  │  |
| │ 👤   │ |  │  ┌──────────┐ ┌──────────┐ ┌──────────┐         │  |
| │ Pro-  │ |  │  │ StatCard │ │ StatCard │ │ StatCard │         │  |
| │ file  │ |  │  │ Users:25 │ │ Plugins:4│ │ Spaces:8 │         │  |
| ├──────┤ |  │  └──────────┘ └──────────┘ └──────────┘         │  |
| │ ⚙️   │ |  │                                                  │  |
| │ Set-  │ |  │  [Content varies by route]                      │  |
| │ tings │ |  │                                                  │  |
| ├──────┤ |  └──────────────────────────────────────────────────┘  |
| │      │ |                                                        |
| │ PLUG- │ |                                                        |
...
≡ tap → Sidebar slides in as overlay (left):
+================+=====================+
| SIDEBAR        |                     |
| (overlay)      |  (dimmed            |
| W: 280px       |   background)       |
...
| -------------------------- | ---------------------------- | -------------------------------------------------------- | ------------------------ |
| Default                    | App load complete            | Full shell with sidebar + content                        | —                        |
| Loading (initial)          | App first load               | Skeleton header + sidebar skeleton + content skeleton    | "Loading..." sr-only     |
| Sidebar collapsed          | Mobile/tablet or user toggle | Sidebar hidden; hamburger icon shown                     | —                        |
...
| Theme applied              | Login + tenant theme fetch   | CSS custom properties set from tenant theme; logo loaded | —                        |
| Dark mode                  | User or system preference    | All tokens switch to dark mode values                    | —                        |

> **Wireframe Scope Note**: Elements shown in the header wireframe that are **outside Spec 005 scope**:
>
> - 🔔 Notification bell — pre-existing feature (or future feature, not implemented by this spec)
> - 🌐 Language selector — owned by Spec 006 (i18n System, already implemented Sprint 1–2)
>
...
| Hamburger (≡)              | Button | Click  | Toggle sidebar overlay (mobile/tablet)   | FR-006, NFR-005 |
| Notification Bell (🔔)     | Button | Click  | Open notification dropdown               | FR-006          |
| Language Selector (🌐)     | Select | Change | Switch locale (per i18n spec 006)        | FR-006          |
| User Menu (👤)             | Button | Click  | Open dropdown: Profile, Settings, Logout | FR-006, FR-012  |
...
| Plugins group toggle (▾)   | Button | Click  | Collapse/expand plugins section          | FR-007          |
...
Focus trap: Yes — when sidebar overlay is open on mobile/tablet
...
Contrast (light mode):
  Foreground (#0A0A0A) on Background (#FFFFFF): 17.4:1 ✓
  Muted foreground (#71717A) on Background (#FFFFFF): 4.7:1 ✓
  Primary foreground (#FFFFFF) on Primary (#0066CC): 5.3:1 ✓
  Active nav item uses --primary background with --primary-foreground text

Contrast (dark mode):
  Foreground (#FAFAFA) on Background (#0A0A0A): 17.4:1 ✓
  Muted foreground (#A1A1AA) on Background (#0A0A0A): 4.6:1 ✓
  Primary foreground (#FFFFFF) on Primary (#3B82F6): 4.6:1 ✓
...
Screen reader flow:
  ...
  6. "CRM, link" → "Billing, link" (plugin items)
...
|          |                                                        |
| 🏠 Dash  |  ┌──────────────────────────────────────────────────┐  |
| 👤 Prof  |  │ [Breadcrumb: Home > CRM > Contacts]              │  |
| ⚙️ Set   |  │                                                  │  |
| ────────  |  │ ┌────────────────────────────────────────────┐   │  |
| PLUGINS   |  │ │ ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░ │   │  |
...
| 👤 Prof  |  │ [Breadcrumb: Home > CRM > Contacts]              │  |
| ⚙️ Set   |  │                                                  │  |
| ────────  |  │ [CRM Contacts Page — Plugin Content]             │  |
| PLUGINS   |  │                                                  │  |
| ▸ [📊    |  │ ┌────────┐ ┌───────────────────────────────────┐  │  |
|   CRM]*   |  │ │ Search │ │ [Search___________________] 🔍  │  │  |
| ▸ 💰     |  │ └────────┘ └───────────────────────────────────┘  │  |
|   Bill    |  │                                                  │  |
|           |  │ ┌─────────────────────────────────────────────┐  │  |
|           |  │ │ Name        │ Email          │ Phone       │  │  |
...
|           |  │ │ Jane Doe    │ jane@acme.com  │ 555-5678    │  │  |
|           |  │ └─────────────┴────────────────┴─────────────┘  │  |
|           |  │                                                  │  |
|           |  └──────────────────────────────────────────────────┘  |
+==================================================================+
...
| Error   | Remote fetch failure           | Error boundary (see Screen 3)                                                                    | —                                          |
...
|   CRM]*   |  │                                                  │  |
| ▸ 💰     |  │   The plugin could not be loaded. The rest of     │  |
|   Bill    |  │   the application is not affected.                │  |
|           |  │                                                  │  |
|           |  │   [ 🔄 Try Again ]    [ 🏠 Go to Dashboard ]     │  |
|           |  │                                                  │  |
|           |  │   If this problem continues, contact your         │  |
|           |  │   administrator.                                  │  |
|           |  │                                                  │  |
|           |  └──────────────────────────────────────────────────┘  |
|           |                                                        |
...
Contrast:
  AlertTriangle icon (#D97706 on #FFFFFF): 4.5:1 ✓
  Error text (#0A0A0A on #FFFFFF): 17.4:1 ✓
...
| ────────  |  │           🔍                                     │  |
| PLUGINS   |  │                                                  │  |
| (CRM not  |  │   Page Not Found                                 │  |
|  listed)  |  │                                                  │  |
|  💰 Bill  |  │   This feature is not available for your          │  |
|           |  │   organization. If you believe this is a           │  |
...
|          |                                                        |
| 🏠 Dash  |  ┌──────────────────────────────────────────────────┐  |
| 👤 Prof  |  │ [Breadcrumb: Home > Settings > Branding]         │  |
| ⚙️ [Set  |  │                                                  │  |
|   tings]*|  │ Branding Settings                                │  |
| ────────  |  │ Customize your organization's appearance          │  |
| PLUGINS   |  │                                                  │  |
| ▸ 📊CRM  |  │ ┌─── FORM PANEL ──────────┬── LIVE PREVIEW ────┐ │  |
| ▸ 💰Bill |  │ │                          │                    │ │  |
|           |  │ │ Logo                     │ ┌──────────────┐  │ │  |
|           |  │ │ ┌────────────────────┐   │ │ [ThemePreview]│  │ │  |
|           |  │ │ │ [current-logo.png] │   │ │              │  │ │  |
...
| State                 | Trigger                                  | Visual Change                                                                        | User Feedback                        |
| --------------------- | ---------------------------------------- | ------------------------------------------------------------------------------------ | ------------------------------------ |
| Default               | Page load                                | Form populated with current theme values; preview shows current look                 | —                                    |
| Editing               | User changes any value                   | Preview updates live; "Save" button enables; "Unsaved changes" indicator             | —                                    |
...
| Contrast warning      | Valid color but low contrast             | Orange warning: "Contrast ratio 1.2:1 — does not meet WCAG AA (minimum 4.5:1)"       | aria-live="polite" announces warning |
| Contrast pass         | Valid color with good contrast           | Green check: "✅ 5.3:1 — Passes WCAG AA"                                             | —                                    |
...
| Dirty form navigation | User navigates away with unsaved changes | Browser confirms: "You have unsaved changes. Are you sure you want to leave?"        | —                                    |
...
| ColorPicker (×5)      | Input + swatch     | Type hex / click swatch | Updates preview live; validates hex; shows contrast ratio                        | FR-009, FR-015 |
...
| Reset to Default      | Button (ghost)     | Click                   | Confirmation dialog: "Reset all branding to Plexica defaults?" → Reset or Cancel | FR-010         |
| Cancel                | Button (secondary) | Click                   | Reverts unsaved changes; navigates back                                          | —              |
...
Tab order:
  [1] Logo upload area
  [2] Primary color input → [3] Primary color picker swatch
  [4] Secondary color input → [5] Secondary color picker swatch
  [6] Background color input → [7] Background color picker swatch
  [8] Surface color input → [9] Surface color picker swatch
  [10] Text color input → [11] Text color picker swatch
...
ARIA:
  ...
  ThemePreview: aria-hidden="true" (decorative — live preview is visual only)
  Save button: aria-disabled="true" when no changes; text changes to "Saving..." with aria-busy

Contrast:
  Form labels (#0A0A0A on #FFFFFF): 17.4:1 ✓
  Contrast warning text (#D97706 on #FFFFFF): 4.5:1 ✓
  Green check text (#16A34A on #FFFFFF): 4.5:1 ✓
...
```
+==================================================================+
|  ░░░░░░░░░░░░░ (dimmed background - entire shell) ░░░░░░░░░░░░  |
|  ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░  |
|  ░░░░░  ┌──────────────────────────────────────┐  ░░░░░░░░░░░░░  |
|  ░░░░░  │                                      │  ░░░░░░░░░░░░░  |
|  ░░░░░  │          🔒                           │  ░░░░░░░░░░░░░  |
...
| Redirect   | OAuth login URL constructed                             | Browser navigates to Keycloak login page with redirect_uri=current_path                | —                                          |
...
Focus trap: Yes — only the Sign In button is focusable. No close button. No Esc dismiss.

Tab order:
  [1] Sign In button (only focusable element)

Contrast:
  Modal text (#0A0A0A on #FFFFFF): 17.4:1 ✓
...
|  [TenantLogo]  Plexica          [🔔] [🌐 EN ▾] [👤 Dana ▾]     |
+==================================================================+
| ⚠️ Unable to refresh your session. Your current session will     [✕]|
|    remain active until it expires.                                  |
+==================================================================+
|          |                                                        |
| SIDEBAR  |  MAIN CONTENT AREA                                    |
|          |  (normal content — user can continue working)          |
|          |                                                        |
+==================================================================+
```
...
| Dismissed | User clicks ✕                              | Banner disappears; condition still exists                                          | —                                    |
| Resolved  | Subsequent refresh succeeds                | Banner automatically removed                                                       | —                                    |
| Escalated | Token actually expires                     | SessionExpiredModal appears (Screen 6)                                             | —                                    |

#### Interactive Elements

| Element     | Type          | Action | Outcome                  | FR Ref |
| ----------- | ------------- | ------ | ------------------------ | ------ |
| Dismiss (✕) | Button (icon) | Click  | Hides the warning banner | FR-013 |
...
Contrast:
  Warning icon (#D97706) on warning bg (#FFFBEB): 4.5:1 ✓
  Warning text (#0A0A0A) on warning bg (#FFFBEB): 16.2:1 ✓
...
|          |                                                        |
| 🏠 Dash  |  ┌──────────────────────────────────────────────────┐  |
| 👤 Prof  |  │ [Breadcrumb: Home > Projects > Acme Redesign]    │  |
| ⚙️ Set   |  │                                                  │  |
| ────────  |  │ Acme Redesign                                    │  |
| PLUGINS   |  │ Status: In Progress                              │  |
| ▸ 📊CRM  |  │                                                  │  |
| ▸ 💰Bill |  │ ┌─────── Related Contacts ─────────────────────┐ │  |
| ▸ [📋    |  │ │                                               │ │  |
|   Proj]* |  │ │ ┌──────────────┐  ┌──────────────┐           │ │  |
...
|           |  │ │ │ john@acme   │  │ jane@acme    │           │ │  |
|           |  │ │ │ 📞 555-1234 │  │ 📞 555-5678  │           │ │  |
|           |  │ │ │ [View in CRM]│  │ [View in CRM]│           │ │  |
|           |  │ │ └──────────────┘  └──────────────┘           │ │  |
|           |  │ │                                               │ │  |
|           |  │ └───────────────────────────────────────────────┘ │  |
|           |  │                                                  │  |
|           |  │ ┌─────── Project Details ────────────────────┐   │  |
|           |  │ │ [Normal plugin content continues below]    │   │  |
|           |  │ └────────────────────────────────────────────┘   │  |
|           |  └──────────────────────────────────────────────────┘  |
+==================================================================+
```
...
| Error (fallback) | Widget remote unavailable   | Fallback placeholder (see Screen 9)                      | —                           |
...
Keyboard:
  Tab to each ContactCard → Tab to "View in CRM" link within
...
None — the fallback is static. Page refresh retries widget load.
...
Contrast:
  Info icon (#2563EB) on muted bg (#F4F4F5): 4.8:1 ✓
  Fallback text (#71717A) on muted bg (#F4F4F5): 3.1:1 — use #52525B for 4.5:1 ✓
...
Contrast:
  Lock icon and heading (#0A0A0A) on surface (#FFFFFF): 17.4:1 ✓
  Body text (#71717A) on surface (#FFFFFF): 4.7:1 ✓
...
| Existing?   | No (new — shell component) |
...
| State             | Visual                                            | Aria                  |
| ----------------- | ------------------------------------------------- | --------------------- |
| Default           | Items listed vertically, muted foreground         | —                     |
...
>
> - **Page level** (`level: "page"`): → `PluginErrorBoundary` + `PluginErrorFallback` (Spec 010, Phase 1, T010-1.1–1.3)
> - **Widget level** (`level: "widget"`): → `WidgetLoader` + `WidgetFallback` (Spec 010, Phase 3, T010-3.x)
>
...
- `pluginId`: string — identifies which plugin
- `fallback`: ReactNode — custom loading state (default: Skeleton)
- `errorFallback`: ReactNode — custom error state (default: built-in error card)
- `level`: "page" | "widget" — determines error boundary behavior
...
| Existing?   | Listed in design-system.md § New Components Needed (Spec 001), not yet built |
...
| Updating | Theme values change live as form inputs change | —                               |
...
**Keyboard behavior**: None — decorative component, not interactive.
...
| Focused               | Focus ring on input                                             | —                                                    |
| Valid (good contrast) | Green check + ratio text: "✅ 5.3:1 — Passes WCAG AA"           | aria-describedby="[id]-contrast"                     |
| Valid (poor contrast) | Orange warning + ratio text: "⚠️ 1.2:1 — Does not meet WCAG AA" | aria-describedby="[id]-contrast", aria-live="polite" |
...
- `label`: string
- `value`: string (hex)
- `contrastAgainst`: string (hex) — reference color for contrast calculation
...
- `redirectUri`: string — current page URL for post-login redirect
- `onSignIn`: () => void — initiates OAuth flow
...
| FR coverage | FR-013                                     |
| Existing?   | No (new — extends Alert component pattern) |
...
| Dismissed | Banner removed from DOM                                             | —                                |
| Resolved  | Banner auto-removed when refresh succeeds                           | —                                |
...
| FR coverage | FR-008                                |
| Existing?   | No (new — extends EmptyState pattern) |
...
- `message`: string (optional — default: "This feature is not available for your organization.")
...
- `pluginId`: string — source plugin for widget
- `widgetName`: string — exposed component name
- `widgetProps`: Record<string, unknown> — props to pass through
...
| --------------------- | ------------ | ------------------------------------------------------------------------------------------------------- |
| App Shell Layout      | ✅ Compliant | Skip link, landmark regions, keyboard nav, focus trap on mobile overlay, contrast verified              |
| Plugin Loading        | ✅ Compliant | aria-busy, aria-live announcements for load start/complete, focus management                            |
| Plugin Error Boundary | ✅ Compliant | role="alert", keyboard-operable retry, descriptive error text                                           |
| Disabled Plugin (404) | ✅ Compliant | h1 heading, CTA keyboard accessible                                                                     |
| Tenant Theme Settings | ✅ Compliant | Form labels, contrast indicators with aria-live, keyboard tab order through all fields                  |
| Session Expired Modal | ✅ Compliant | Focus trap, aria-modal, aria-labelledby, non-dismissable by design                                      |
| Auth Warning Banner   | ✅ Compliant | role="alert", dismissible, contrast verified against warning background                                 |
| Widget Embed          | ✅ Compliant | region landmark, article roles for widgets, labeled links                                               |
| Widget Fallback       | ⚠️ Note      | Fallback text contrast adjusted: use `#52525B` instead of `#71717A` on muted background for 4.5:1 ratio |

**Open accessibility items**:

- [ ] Widget fallback text: update `--muted-foreground` usage on `--muted` background to use `#52525B` (or add `--muted-foreground-strong` token) for 4.5:1 contrast compliance — affects widget fallback card only
