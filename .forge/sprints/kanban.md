...
Sprint 6:  [→] In Progress (2026-09-17 → 2026-10-08)   5/13 stories done   006-01 → 006-05  — Spec 006 (Cross-Cutting) — 11/27 pts earned
Sprint 7:  [ ] Not Started  — Spec 007
```

**Sprint 6 — Spec 006 (Cross-Cutting), normalized scale** — story list in
`.forge/sprints/active/sprint-006.yaml`. Progress as of 2026-09-22:
**5/13 stories done** (006-01..006-05, notifications — 11 pts) via PRs #178,
#180, #195. Next: Phase 4 i18n kickoff (006-06).
...
**Total**: 13 stories, 27 pts. **Progress**: 5/13 stories done (006-01..006-05,
notifications — 11 pts earned). **Remaining**: 8 stories, 16 pts (i18n →
profile → observability). Deferred to Sprint 7: OTel tracing (006-19, optional).
