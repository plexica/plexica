...
**Last Updated**: March 9, 2026 (Spec 014 TD-026–TD-039 all resolved; 145 layout-engine tests passing)
...
| TD-024 | ~~Spec 014 frontend components missing test coverage~~ — **RESOLVED in Pass 2**: 7 new test files with 100+ tests added. Residual gap (TD-032): US-007 save + warning dialog flow still untested.                                                                                                                                                                                                                                                                                                      | Quality         | ~~HIGH~~ CLOSED   | forge-review-3 2026-03-08 | Closed                       |
| TD-025 | ~~`LayoutAwareForm` element-children mode section grouping~~ — **RESOLVED in Pass 2**: `childSectionMap` injected correctly via `React.cloneElement`.                                                                                                                                                                                                                                                                                                                                                  | Quality         | ~~MEDIUM~~ CLOSED | forge-review-3 2026-03-08 | Closed                       |
| TD-026 | ~~Stale `loadForms` `useCallback` closure~~ — **RESOLVED 2026-03-09**: Removed `selectedFormId` from `useCallback` deps; added `autoSelectedRef` guard; removed `eslint-disable-next-line` suppressor.                                                                                                                                                                                                                                                                                                 | Maintainability | ~~MEDIUM~~ CLOSED | forge-review-3 2026-03-08 | Closed                       |
| TD-027 | ~~`buildSaveInput` not in `useCallback`~~ — **RESOLVED 2026-03-09**: Inlined `buildSaveInput` body into `handleSave` `useCallback`; removed `eslint-disable-next-line` suppressor.                                                                                                                                                                                                                                                                                                                     | Maintainability | ~~MEDIUM~~ CLOSED | forge-review-3 2026-03-08 | Closed                       |
| TD-028 | ~~`savedConfig.updatedBy` renders as raw UUID~~ — **RESOLVED 2026-03-09**: Wrapped in `<span title={savedConfig.updatedBy}>` tooltip; test updated to match split-node text.                                                                                                                                                                                                                                                                                                                           | UX              | ~~LOW~~ CLOSED    | forge-review-3 2026-03-08 | Closed                       |
