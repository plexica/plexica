...
| 0.2 | Docker Compose completo per sviluppo                 | PostgreSQL, Keycloak, Redis, MinIO, Redpanda (1 nodo), Mailpit                                  |
...
| 2.2.2 | Invito utente via email       | Admin invita utente, email arriva (Mailpit in test), utente accetta e fa login |
...
| 5.1.3 | Notifiche email                        | Invito workspace arriva via email (Mailpit in test)               |
...
_Fine del Documento di Progetto — Revisione 2_
